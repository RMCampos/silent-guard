...
* The original package name 'br.com.ricardocampos.silent-guard-api' is invalid and this project uses 'br.com.ricardocampos.silent_guard_api' instead.
...
```
$ docker run --rm -p 8080:8080 silent-guard-api:0.0.1-SNAPSHOT
```
